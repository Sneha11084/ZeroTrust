    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center px-4 py-8">
      ...
      >
        <div className="space-y-3 text-center">
          ...
          <p className="text-sm text-slate-400">Create your secure account and get started.</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {success && (
            <div className="rounded-2xl bg-emerald-500/10 border border-emerald-500/30 px-4 py-3 text-sm text-emerald-200">
              {success}
            </div>
          )}
